...
def parse_links_file(file_path):
    """Parse the Halyk_links file and extract PDF URLs with metadata."""
    ...
    for i, line in enumerate(lines):
        ...
        if line.startswith('http'):
            ...
            elif 'Годовой отчет' in prev_line or 'Annual Report' in prev_line or 'Annual_Report' in prev_line:
                doc_type = 'Annual_Report'
            elif 'Financial Statements' in prev_line:
