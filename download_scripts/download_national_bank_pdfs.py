...
def parse_links_file(file_path):
    """Parse the National_Bank_links.txt file and extract PDF URLs with metadata."""
    ...
    for i, line in enumerate(lines):
        ...
        # Extract year (e.g., "2023 ГОД:" or "2021-2022 ГОД:")
        year_match = re.search(r'([\d\-]+)\s+ГОД', line)
        if year_match:
